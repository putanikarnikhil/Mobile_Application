...
const INITIAL_TASKS: Task[] = [
  {
    id: '1', orderId: 'ORD-2024-001', orderStageId: 'STG-KNT-001', taskId: 'TSK-KNT-2024-001',
    factory: 'Premium Textiles Ltd', product: 'Cotton Polo Shirt', stage: 'Knitting',
    stageStatus: 'Active', taskType: 'Quality Check', status: 'Pending Review',
    isOverdue: false, isSubmitted: false, isCompleted: false, isRejected: false,
    photos: [], comments: 'Initial inspection required.',
  },
  // Example of a task that has been submitted and should show audit data
  {
    id: '2', orderId: 'ORD-2024-002', orderStageId: 'STG-DYG-001', taskId: 'TSK-DYG-2024-002',
    factory: 'Bright Dyes Inc', product: 'Denim Fabric', stage: 'Dyeing',
    stageStatus: 'Active', taskType: 'Color Audit', status: 'Submitted',
    isOverdue: false, isSubmitted: true, isCompleted: false, isRejected: false,
    photos: [mockImageUri, mockImageUri2, mockImageUri, mockImageUri2],
    comments: 'Task submitted successfully.',
    submissionData: {
      auditComment: 'Dye lot 4A checked. Color match is 98%. Ready for next stage.',
  ...
  {
    id: '3', orderId: 'ORD-2024-003', orderStageId: 'STG-FIN-001', taskId: 'TSK-FIN-2024-003',
    factory: 'Quick Finish Co', product: 'Jacket Linings', stage: 'Finishing',
    stageStatus: 'Active', taskType: 'Durability Test', status: 'Pending Review',
    isOverdue: true, isSubmitted: false, isCompleted: false, isRejected: false,
    photos: [], comments: 'Urgent: Must be completed today.',
  },
  {
    id: '4', orderId: 'ORD-2024-004', orderStageId: 'STG-TRM-001', taskId: 'TSK-TRM-2024-004',
    factory: 'Trim Master', product: 'Buttons & Zippers', stage: 'Trimming',
    stageStatus: 'Completed', taskType: 'Inventory Check', status: 'Completed',
    isOverdue: false, isSubmitted: true, isCompleted: true, isRejected: false,
    photos: [mockImageUri], comments: 'Inventory confirmed.',
  },
];
...
const App: React.FC = () => {
  ...
  const [appAuthState, setAppAuthState] = useState<{ user: User | null, view: 'login' | 'tasks' }>({
  ...
  const appState: AppState & { setProfileImage: React.Dispatch<React.SetStateAction<string | null>>; } = useMemo(() => ({
    ...
    appAuthState.user, appAuthState.view, activeSection, 
    tempImages, tempComment, profileImage
  ]);
