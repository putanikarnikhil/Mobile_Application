...
import { View, Text, TouchableOpacity, StatusBar, TextInput, Alert, Image, Platform, ScrollView, ActivityIndicator } from 'react-native';
...
const ProfilePage: React.FC<ProfilePageProps> = ({ 
    ...
    (async () => {
      if (Platform.OS !== 'web') {
        ...
        if (mediaLibraryStatus !== 'granted' || cameraStatus !== 'granted') {
          Alert.alert("Permission Required", "Please enable camera and media library permissions in your phone settings to set a profile picture.");
        }
      }
    })();
  }, []);
  ...
  return (
    <View style={[{ paddingTop: insets.top, flex: 1 }, globalStyles.profileSafeArea]}>
      ...
      <ScrollView contentContainerStyle={globalStyles.profileScrollView}>
        <View style={globalStyles.profileContent}>
          ...
          >
            {profileImage ? (
              <Image source={{ uri: profileImage }} style={globalStyles.profileAvatarImage} />
            ) : (
              <Ionicons name="mail" size={70} color={ColorConstants.primaryAccent} />
            )}
          ...
          {isEditingName ? (
            <View style={globalStyles.nameEditContainer}>
              ...
              <TouchableOpacity 
                ...
                disabled={loggingOut}
              >
                <Ionicons name="checkmark" size={24} color={ColorConstants.primaryAccent} />
              </TouchableOpacity>
            </View>
          ) : (
            <View style={globalStyles.nameDisplayContainer}>
              ...
              <TouchableOpacity 
                ...
                disabled={loggingOut}
              >
                <Ionicons name="pencil-outline" size={20} color={ColorConstants.faintText} />
              </TouchableOpacity>
            </View>
          )}
          ...
          <View style={globalStyles.profileMenu}>
            ...
            >
              ...
              <Text style={globalStyles.profileMenuItemText}>Notifications</Text>
              <Ionicons name="chevron-forward-outline" size={22} color={ColorConstants.mediumText} />
            </TouchableOpacity>
          </View>
