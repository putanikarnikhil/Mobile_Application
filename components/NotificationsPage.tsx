...
type NotificationsPageNavigationProps = RootStackScreenProps<'NotificationsModal'>;
  ...
  return (
    <View style={[{ paddingTop: insets.top }, styles.profileSafeArea]}>
      ...
      <View style={styles.profileContent}>
        <Ionicons name="notifications-outline" size={100} color={ColorConstants.faintText} style={{ opacity: 0.5 }} />
